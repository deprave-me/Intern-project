    ...
    <body>
        ...
        <div class="container-fluid" style=" display: flex; flex-wrap: wrap; ">
            <div class="flex-item-left" style="margin-top:12px; flex:35%">  
                ...
                <img class="product-image " src="./images/keyb5.jpg" alt="Card image" style=" height: 40vh;
            ...
            <div class="flex-item-right" style="flex:65%; ">
                ...
                <div class="row">
                    <h2 id="name" style="margin-left:7vh; color:white;">gaming keyboard</h2>  

                </div>
                <hr style="background-color:white; opacity: 0.5; width:50%; margin-left:5vh">


                <h3 id="name" style="margin-left:5vh; color:white; margin-top:1vh; ">$70</h3>
                </br>    
                <h3 id="name" style="margin-left:5vh; color:white;">A classic gaming keyboard with a knob to control general audio on your connected device.</h3>
                </br>

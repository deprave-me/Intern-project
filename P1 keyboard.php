    ...
    <body>
        ...
        <div class="container-fluid" style=" display: flex; flex-wrap: wrap; ">
            <div class="flex-item-left" style="margin-top:12px; flex:35%">  
                ...
                <img class="product-image " src="./images/keyb1.jpg" alt="Card image" style=" height: 40vh;
            ...
            <div class="flex-item-right" style="flex:65%; ">
                ...
                <div class="row">
                    <h2 id="name" style="margin-left:7vh; color:white;">P1 keyboard</h2>  

                </div>
                <hr style="background-color:white; opacity: 0.5; width:50%; margin-left:5vh">


                <h3 id="name" style="margin-left:5vh; color:white; margin-top:1vh; ">$100</h3>
                </br>    
                <h3 id="name" style="margin-left:5vh; color:white;">New series of keyboards that are customizable at an affordable price.</h3>
                </br>
